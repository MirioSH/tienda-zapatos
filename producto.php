        ...
        <div class="two-col" id="detalle-producto">
            ...
            <div>
                <div style="background:var(--surface-container);border-radius:var(--radius-lg);overflow:hidden;margin-bottom:16px;">
                    <img src="img/<?php echo $producto['imagen']; ?>" alt="<?php echo $producto['nombre']; ?>" id="img-principal" style="width:100%;aspect-ratio:1;object-fit:cover;transition: transform 0.3s;" onmouseover="this.style.transform='scale(1.15)'" onmouseout="this.style.transform='scale(1)'">
                </div>
